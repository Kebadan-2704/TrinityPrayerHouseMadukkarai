...
const translations = {
  en: {
    ...
    hindiMin: 'Hindi Ministry', hindiDesc: 'Reaching out to the Hindi-speaking community with worship and the Word.',
    oldAgeMin: 'Old Age Home', oldAgeDesc: 'Providing care, love, and spiritual support for the elderly.',
    branchMin: 'Branch Churches', branchDesc: 'Expanding the Kingdom of God through our network of local branch churches.',
    // Events
  ...
  ta: {
    ...
    hindiMin: 'இந்தி ஊழியம்', hindiDesc: 'ஆராதனை மற்றும் வார்த்தையுடன் இந்தி பேசும் சமூகத்தை அடைதல்.',
    oldAgeMin: 'முதியோர் இல்லம்', oldAgeDesc: 'முதியோர்களுக்கு கவனிப்பு, அன்பு மற்றும் ஆன்மீக ஆதரவை வழங்குதல்.',
    branchMin: 'கிளை திருச்சபைகள்', branchDesc: 'எங்கள் உள்ளூர் கிளை திருச்சபைகள் மூலம் கடவுளின் ராஜ்யத்தை விரிவுபடுத்துதல்.',
  ...
  hi: {
    ...
    hindiMin: 'हिंदी सेवकाई', hindiDesc: 'आराधना और वचन के साथ हिंदी भाषी समुदाय तक पहुँचना।',
    oldAgeMin: 'वृद्धाश्रम', oldAgeDesc: 'बुजुर्गों के लिए देखभाल, प्रेम और आध्यात्मिक सहायता प्रदान करना।',
    branchMin: 'शाखा चर्च', branchDesc: 'हमारे स्थानीय शाखा चर्चों के नेटवर्क के माध्यम से परमेश्वर के राज्य का विस्तार करना।',
