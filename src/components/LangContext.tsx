...
const translations = {
  en: {
    ...
    prayerMin: 'Prayer Ministry', prayerDesc: 'Intercessory prayer covering the church, city, and nation. We believe in the power of united prayer.',
  ...
  ta: {
    ...
    prayerMin: 'ஜெப ஊழியம்', prayerDesc: 'திருச்சபை, நகரம் மற்றும் தேசத்தை மறைக்கும் பரிந்துரை ஜெபம். ஒருமித்த ஜெபத்தின் வல்லமையை நாங்கள் நம்புகிறோம்.',
  ...
  hi: {
    ...
    prayerMin: 'प्रार्थना सेवकाई', prayerDesc: 'चर्च, शहर और राष्ट्र को ढकने वाली मध्यस्थ प्रार्थना। हम एकजुट प्रार्थना की शक्ति में विश्वास करते हैं।',
